...
const PROJECTS = [
  ...
  /* ===== 1. PEOPLE ANALYTICS ============================================== */
  {
    ...
    gallery: ["assets/img/people-analytics/cover.png",
              "assets/img/people-analytics/slide1.png",
              "assets/img/people-analytics/slide2.png",
              "assets/img/people-analytics/slide3.png"
    ],
    repo: "",
  ...
  /* ===== 4. SQL / CAP - PR =============================================== */
  {
    ...
    gallery: ["assets/img/cap/cover.png",
              "assets/img/cap/sql1.png",
              "assets/img/cap/sql2.png",
              "assets/img/cap/sql3.png",
              "assets/img/cap/sql4.png",
              "assets/img/cap/sql5.png",
              "assets/img/cap/slide1.png",
              "assets/img/cap/slide2.png",
              "assets/img/cap/slide3.png",
              "assets/img/cap/slide4.png",
              "assets/img/cap/slide5.png"
    ],
